        ...
        <nav>
          <ul className="space-y-5 text-white ml-3">
            ...
            <li>
              ...
              >
                <MdOutlinePeopleAlt className="mr-2" /> Employee
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                <MdEventAvailable className="mr-2" /> Attendance
              </NavLink>
            </li>
            <li>
              <NavLink
            ...
            <li>
              ...
              >
                <MdOutlineHolidayVillage className="mr-2" /> Holiday
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                <FaDailymotion className="mr-2" /> Daily
              </NavLink>
            </li>
            <li className="pt-5">
              <NavLink
